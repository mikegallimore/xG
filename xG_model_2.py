...
shots_test_season = 'shots_test-season.csv'

### create a dataframe of the seed data; duplicate it and drop unneeded columns
shots_df = pd.read_csv(shots_training_seasons)
xg_df = shots_df.copy()
xg_df = xg_df.drop(columns=['SEASON', 'GAME_ID', 'HOME', 'AWAY', 'HOME_GOALS', 'AWAY_GOALS', 'HOME_SCOREDIFF', 'AWAY_SCOREDIFF', 'HOME_SITUATION', 'AWAY_SITUATION', 'HOME_ZONE', 'AWAY_ZONE', 'XG_MONEYPUCK'])
...
continuous_variables = ['SECONDS_GONE', 'X_1', 'Y_1', 'SECONDS_LAST_EVENT', 'ANGLE', 'DISTANCE', 'DISTANCE_LAST_EVENT']
boolean_variables = ['IS_ON_NET', 'IS_REBOUND', 'IS_BACKHAND', 'IS_REDIRECT', 'IS_SLAP', 'IS_SNAP', 'IS_WRAPAROUND', 'IS_WRIST', 'IS_HOME_LEADING', 'IS_HOME_TIED', 'IS_HOME_TRAILING', 'IS_HOME_EV', 'IS_HOME_PP', 'IS_HOME_SH']
