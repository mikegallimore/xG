...
for file in infiles:
    ...
    # rename select columns in order to distinguish MoneyPuck values from those attempted via this script
    ...
    shots_df['IS_TEAM_NET_EMPTY'] = np.where((shots_df.TEAM == shots_df.HOME) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '6v5') | (shots_df.TEAM == shots_df.HOME) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '6v4') | (shots_df.TEAM == shots_df.HOME) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '5v4') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '6v5') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '6v4') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '5v4'), 1, 0)
    shots_df['IS_OPP_NET_EMPTY'] = np.where((shots_df.TEAM == shots_df.HOME) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '6v5') | (shots_df.TEAM == shots_df.HOME) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '6v4') | (shots_df.TEAM == shots_df.HOME) & (shots_df.AWAY_STATE == 'EN') & (shots_df.AWAY_STRENGTH == '5v4') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '6v5') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '6v4') | (shots_df.TEAM == shots_df.AWAY) & (shots_df.HOME_STATE == 'EN') & (shots_df.HOME_STRENGTH == '5v4'), 1, 0)
